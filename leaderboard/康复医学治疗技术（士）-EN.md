...
|Category|Organization|Model|[Rehabilitation Medicine Therapy Technology（士）]Accuracy|Avg Time|Avg Tokens|Cost / 1k calls (CNY)|Rank (by Accuracy)|
|---|---|-----|-------------------|-------|-----------|-----------|-----------|
...
![lin](../pic/Rehabilitation Medicine Therapy Technology（士）.png)